...
.Ltext0:
	...
	.file 0 "/home/ubuntu/course/lab6/lab-wlos_baseline/testbench/counter_la_wlop" "../../firmware/isr.c"
	.align	2
...
.LFE203:
	...
	.align	2
	.type	user_irq_1_ev_pending_write, @function
user_irq_1_ev_pending_write:
.LFB223:
	.loc 3 871 60
	.cfi_startproc
	addi	sp,sp,-32
	...
	.cfi_endproc
.LFE223:
	.size	user_irq_1_ev_pending_write, .-user_irq_1_ev_pending_write
	.align	2
...
.L11:
	...
	.loc 5 46 9
	li	a0,1
	call	user_irq_1_ev_pending_write
	.loc 5 47 27
	li	a5,-268423168
	addi	a5,a5,56
	lw	a5,0(a5)
...
.LASF17:
	.string	"mprj_to_uart0"
.LASF18:
	.string	"mprj_to_uart1"
.LASF19:
	.string	"mprj_to_uart2"
.LASF15:
	.string	"uart_read"
.LASF30:
	.string	"counter"
...
.LASF7:
	.string	"uint8_t"
.LASF24:
	.string	"user_irq_1_ev_pending_write"
.LASF5:
