# 0 "counter_la_mm.c"
# 1 "/home/ubuntu/course/lab6/lab-wlos_baseline/testbench/counter_la_wlop//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "counter_la_mm.c"
# 19 "counter_la_mm.c"
...
# 78 "counter_la_mm.c"
 ...
 (*(volatile uint32_t*)0x2600000c) = (*(volatile uint32_t*) ((0xf0000000L + 0x3030L) + 8)) = 0xAB400000;
# 148 "counter_la_mm.c"
 mask = irq_getmask();
 mask |= 1 << 2;
 mask |= 1 << 3;
 ...
 tmp = matmul();
 (*(volatile uint32_t*)0x2600000c) = (*(volatile uint32_t*) ((0xf0000000L + 0x3030L) + 8)) = *tmp << 16;
 (*(volatile uint32_t*)0x2600000c) = (*(volatile uint32_t*) ((0xf0000000L + 0x3030L) + 8)) = *(tmp+1) << 16;
 (*(volatile uint32_t*)0x2600000c) = (*(volatile uint32_t*) ((0xf0000000L + 0x3030L) + 8)) = *(tmp+2) << 16;
 (*(volatile uint32_t*)0x2600000c) = (*(volatile uint32_t*) ((0xf0000000L + 0x3030L) + 8)) = *(tmp+3) << 16;



 (*(volatile uint32_t*)0x2600000c) = (*(volatile uint32_t*) ((0xf0000000L + 0x3030L) + 8)) = *(tmp+9) << 16;
 (*(volatile uint32_t*)0x2600000c) = (*(volatile uint32_t*) ((0xf0000000L + 0x3030L) + 8)) = 0xAB510000;
 ...
 (*(volatile uint32_t*)0x2600000c) = (*(volatile uint32_t*) ((0xf0000000L + 0x3030L) + 8)) = *(tmp+2) << 16;
 (*(volatile uint32_t*)0x2600000c) = (*(volatile uint32_t*) ((0xf0000000L + 0x3030L) + 8)) = *(tmp+3) << 16;
 (*(volatile uint32_t*)0x2600000c) = (*(volatile uint32_t*) ((0xf0000000L + 0x3030L) + 8)) = *(tmp+4) << 16;
 (*(volatile uint32_t*)0x2600000c) = (*(volatile uint32_t*) ((0xf0000000L + 0x3030L) + 8)) = *(tmp+5) << 16;
 (*(volatile uint32_t*)0x2600000c) = (*(volatile uint32_t*) ((0xf0000000L + 0x3030L) + 8)) = *(tmp+6) << 16;
 (*(volatile uint32_t*)0x2600000c) = (*(volatile uint32_t*) ((0xf0000000L + 0x3030L) + 8)) = *(tmp+7) << 16;
 (*(volatile uint32_t*)0x2600000c) = (*(volatile uint32_t*) ((0xf0000000L + 0x3030L) + 8)) = *(tmp+8) << 16;
 (*(volatile uint32_t*)0x2600000c) = (*(volatile uint32_t*) ((0xf0000000L + 0x3030L) + 8)) = *(tmp+9) << 16;



 (*(volatile uint32_t*)0x2600000c) = (*(volatile uint32_t*) ((0xf0000000L + 0x3030L) + 8)) = 0xAB520000;
 ...
 (*(volatile uint32_t*)0x2600000c) = (*(volatile uint32_t*) ((0xf0000000L + 0x3030L) + 8)) = 0xAB530000;
# 210 "counter_la_mm.c"
}
